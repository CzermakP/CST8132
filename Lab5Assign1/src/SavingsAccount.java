 ...
 * parameters of a Savings Account. It is a subclass of BankAccount abstract class.
 * 
...
public class SavingsAccount extends BankAccount {
	/**
	 * Double variable to hold the Savings Account interestRate, ranging only from (0-1).
	 */
	private double interestRate;
	/**
	 * Double variable to hold the Savings Account minimumBalance. Must be positive and less than account balance.
	 */
	...
	/**
	 * Parameterized constructor to define the specific parameters a Savings Account must have for a bank account. 
	 * 
	 * @param interestRate		is a double value which must be only from (0 - 1).
	 * @param minimumBalance	is a double value which must be a positive number, and smaller than the account balance.
	 */
	...
	/**
	 * Method toString prints the properly formatted parameters that are required for a Savings Account, 
	 * invokes the super-class BankAccount toString method and combined they print the full parameters of
	 * a Savings Account.
	 */
	@Override
	...
	/**
	 * Method addBankAccount validates user inputed "minimum balance" and "interest rate" before allowing a Savings
	 * Account to be created. Method is overridden by the superclass BankAccount toString method, combined they
	...
	/**
	 * Method monthlyAccountUpdate updates the Savings Account's balance by deducting the interest rate. The method is 
	 * overridden by the superclass BankAccount's monthlyAccountUpdate method.
	 */
	@Override
