...
public abstract class BankAccount {
	...
	public boolean addBankAccount() {
		...
		while (!goodPhoneNumber) {
			...
			if ((!phoneNumber.matches("[0-9]{10,11}") || phoneNumber.contains(" "))) { // ensure phone number is only
																						// string values and only 10 or
																						// 11 numbers long.
	...
	/**
	 * Method updateBalance updates the balance in the object by the parameter
	 * amount.
	 * 
	 * @param amount holds the transaction amount
	 */
